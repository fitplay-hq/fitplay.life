...
export const AdminUpdateOneSchema = z.object({ select: AdminSelectObjectSchema.optional(),  data: z.union([AdminUpdateInputObjectSchema, AdminUncheckedUpdateInputObjectSchema]), where: AdminWhereUniqueInputObjectSchema  })