...
export const AdminCreateOneSchema = z.object({ select: AdminSelectObjectSchema.optional(),  data: z.union([AdminCreateInputObjectSchema, AdminUncheckedCreateInputObjectSchema])  })