...
import { User, Settings, Wallet, History, LogOut, Edit2, Shield, Bell } from 'lucide-react';
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <div className="text-2xl font-bold text-primary">{dashboardStats.totalOrders}</div>
            ...
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <div className="text-2xl font-bold text-primary">{dashboardStats.creditsRemaining}</div>
            ...
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <div className="text-2xl font-bold text-primary">{dashboardStats.wellnessScore}%</div>
            ...
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <div className="text-2xl font-bold text-primary">{dashboardStats.creditsUsed}</div>
                  ...
                  {orderHistory.slice(0, 3).map((order) => (
                    <div key={order.id} className="flex items-center justify-between p-3 border border-gray-100 rounded-lg">
                      <div>
                        ...
                        <p className="text-xs text-gray-500">{order.date} • {order.vendor}</p>
                      </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-600">Fitness Activities</span>
                    <Badge className="bg-green-100 text-green-800">Active</Badge>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-600">Nutrition Planning</span>
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg mt-4">
                    <p className="text-sm text-blue-800 font-medium">Next Recommendation</p>
                    <p className="text-sm text-blue-600">Consider booking a stress management consultation</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => setNotifications({...notifications, wellness: checked})}
                  />
                </div>
                <div className="flex items-center justify-between">
                  <div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-6">
            <Card className="bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200">
              <CardContent className="p-6 text-center">
                ...
                <div className="text-2xl font-bold text-blue-800">{dashboardStats.creditsRemaining}</div>
            ...
            <Card className="bg-gradient-to-br from-green-50 to-green-100 border-green-200">
              <CardContent className="p-6 text-center">
                ...
                <div className="text-2xl font-bold text-green-800">{dashboardStats.creditsUsed}</div>
                ...
                {walletHistory.map((transaction, index) => (
                  <div key={index} className="flex items-center justify-between p-4 border border-gray-100 rounded-lg">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-sm text-gray-500">Balance: {transaction.balance} credits</p>
                    </div>
                  </div>
                ))}
              </div>
                  ...
                  <div key={order.id} className="border border-gray-200 rounded-lg p-4">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between space-y-2 md:space-y-0">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Order #{order.id} • {order.vendor}</p>
