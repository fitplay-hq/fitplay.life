...
export const VariantFindUniqueOrThrowSchema = z.object({ select: VariantSelectObjectSchema.optional(), include: VariantIncludeObjectSchema.optional(), where: VariantWhereUniqueInputObjectSchema })