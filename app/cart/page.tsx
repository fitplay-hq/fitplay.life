...
import { ArrowLeft, Plus, Minus, Trash2, ShoppingBag, MapPin, Check, AlertCircle } from 'lucide-react';
...
export default function CartPage() {
  ...
  const steps = [
    ...
    { id: 'address', label: 'Address', completed: currentStep === 'confirmation' },
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center space-y-6">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-6">Discover wellness products curated for your health journey</p>
            <Link href="/store">
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold text-emerald-600">{totalCredits}</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Available Credits:</span>
                    <span className="text-emerald-600">{userCredits}</span>
                  </div>
                  {!hasEnoughCredits && (
                    <>
                      <Separator />
                ...
                {!hasEnoughCredits && (
                  <Alert>
                    ...
                    <AlertDescription>
                      You need {creditsShortfall} additional credits to complete this order. You can purchase more credits below.
                    </AlertDescription>
                  </Alert>
                )}
                ...
                >
                  {hasEnoughCredits ? 'Proceed to Checkout' : 'Purchase Credits to Continue'}
                </Button>
        ...
        <div className="text-center space-y-6 max-w-2xl mx-auto">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-6">
              Your wellness products have been ordered successfully using your company wellness credits.
            </p>
            <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-6 mb-6">
              <h3 className="font-medium text-emerald-800 mb-2">Order Summary</h3>
              <div className="space-y-1 text-sm text-emerald-700">
                ...
                <div className="flex justify-between">
                  ...
                  <span>{userCredits - totalCredits}</span>
                </div>
              </div>
            </div>
