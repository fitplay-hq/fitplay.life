...
export function VendorsManagement() {
  ...
  const getIntegrationBadge = (integration: string) => {
    return integration === 'API' 
      ? <Badge variant="default" className="bg-blue-100 text-blue-700">API</Badge>
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-2">Manage your vendor partners and their integrations</p>
        </div>
          ...
          <DialogContent className="max-w-2xl">
            ...
            <div className="grid grid-cols-2 gap-4 py-4">
              ...
              <div className="col-span-2 space-y-2">
                ...
                <Textarea id="vendor-description" placeholder="Brief description about the vendor" />
              </div>
            </div>
              ...
              <TableBody>
                {filteredVendors.map((vendor) => (
                  <TableRow key={vendor.id}>
                    ...
                    <TableCell>{getIntegrationBadge(vendor.integration)}</TableCell>
                    <TableCell className="text-right font-medium">{vendor.products}</TableCell>
                    <TableCell className="text-right">{vendor.totalOrders}</TableCell>
                    <TableCell className="text-right font-medium">₹{vendor.revenue.toLocaleString()}</TableCell>
      ...
      <Dialog open={isApiManagementOpen} onOpenChange={setIsApiManagementOpen}>
        <DialogContent className="max-w-2xl">
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor="order-created" className="text-sm">Order Created</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <input type="checkbox" id="order-updated" defaultChecked />
                      <Label htmlFor="order-updated" className="text-sm">Order Updated</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <input type="checkbox" id="stock-updated" defaultChecked />
                      <Label htmlFor="stock-updated" className="text-sm">Stock Updated</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <input type="checkbox" id="product-updated" />
                      <Label htmlFor="product-updated" className="text-sm">Product Updated</Label>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="p-3 border rounded-lg">
                  ...
                  <p className="text-sm text-gray-600 mt-1">All products up to date</p>
                </div>
              </div>
            </div>
          ...
          <div className="flex justify-end gap-3">
            <Button variant="outline" onClick={() => setIsApiManagementOpen(false)}>
              Cancel
            </Button>
            <Button className="bg-emerald-600 hover:bg-emerald-700">
              Save Configuration
