...
const makeSchema = (): z.ZodObject<any> => z.object({
  ...
  variantCategory: z.union([z.lazy(() => StringFilterObjectSchema), z.string().max(50)]).optional().nullable(),
  variantValue: z.union([z.lazy(() => StringFilterObjectSchema), z.string().max(100)]).optional().nullable(),
...
export const VariantWhereInputObjectSchema: z.ZodType<Prisma.VariantWhereInput> = makeSchema() as unknown as z.ZodType<Prisma.VariantWhereInput>;
export const VariantWhereInputObjectZodSchema = makeSchema();
