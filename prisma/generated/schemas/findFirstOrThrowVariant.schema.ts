...
export const VariantFindFirstOrThrowSelectSchema: z.ZodType<Prisma.VariantSelect> = z.object({
...
export const VariantFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    variantCategory: z.boolean().optional(),
    variantValue: z.boolean().optional(),
    mrp: z.boolean().optional(),
...
export const VariantFindFirstOrThrowSchema: z.ZodType<Prisma.VariantFindFirstOrThrowArgs> = z.object({ select: VariantFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => VariantIncludeObjectSchema.optional()), orderBy: z.union([VariantOrderByWithRelationInputObjectSchema, VariantOrderByWithRelationInputObjectSchema.array()]).optional(), where: VariantWhereInputObjectSchema.optional(), cursor: VariantWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([VariantScalarFieldEnumSchema, VariantScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.VariantFindFirstOrThrowArgs>;

export const VariantFindFirstOrThrowZodSchema = z.object({ select: VariantFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => VariantIncludeObjectSchema.optional()), orderBy: z.union([VariantOrderByWithRelationInputObjectSchema, VariantOrderByWithRelationInputObjectSchema.array()]).optional(), where: VariantWhereInputObjectSchema.optional(), cursor: VariantWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([VariantScalarFieldEnumSchema, VariantScalarFieldEnumSchema.array()]).optional() }).strict();