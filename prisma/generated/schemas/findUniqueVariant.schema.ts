...
export const VariantFindUniqueSchema = z.object({ select: VariantSelectObjectSchema.optional(), include: VariantIncludeObjectSchema.optional(), where: VariantWhereUniqueInputObjectSchema })